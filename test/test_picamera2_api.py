...
def test_camera_init_state_matches_real(executor: AstroPiExecutor):
    ...
    assert picam2._raw_modes == [
        {"format": "SRGGB10_CSI2P", "size": (1332, 990)},
        {"format": "SRGGB12_CSI2P", "size": (2028, 1080)},
        {"format": "SRGGB12_CSI2P", "size": (2028, 1520)},
        {"format": "SRGGB12_CSI2P", "size": (4056, 3040)},
    ]
...
def test_configure_with_default_still_configuration(executor: AstroPiExecutor):
    picam2 = Picamera2Adapter(executor)
    ...
    assert picam2.camera_properties_ == {
        "Model": "imx477",
...
def test_configure_with_default_video_configuration(executor: AstroPiExecutor):
    picam2 = Picamera2Adapter(executor)
    config = picam2.create_video_configuration()
    picam2.configure(config)

    # picam2.libcamera_config == <libcamera._libcamera.CameraConfiguration object at 0x7f8ed8a9b0>
    # assert picam2.camera_ctrl_info == {'AeExposureMode': (libcamera.ControlId(5, AeExposureMode, ControlType.Integer32), libcamera.ControlInfo([0..3])), 'AeMeteringMode': (libcamera.ControlId(3, AeMeteringMode, ControlType.Integer32), libcamera.ControlInfo([0..3])), 'AwbMode': (libcamera.ControlId(16, AwbMode, ControlType.Integer32), libcamera.ControlInfo([0..7])), 'AeFlickerMode': (libcamera.ControlId(9, AeFlickerMode, ControlType.Integer32), libcamera.ControlInfo([0..1])), 'AnalogueGain': (libcamera.ControlId(8, AnalogueGain, ControlType.Float), libcamera.ControlInfo([1.000000..22.260870])), 'FrameDurationLimits': (libcamera.ControlId(28, FrameDurationLimits, ControlType.Integer64), libcamera.ControlInfo([19989..674193371])), 'AeConstraintMode': (libcamera.ControlId(4, AeConstraintMode, ControlType.Integer32), libcamera.ControlInfo([0..3])), 'NoiseReductionMode': (libcamera.ControlId(10002, NoiseReductionMode, ControlType.Integer32), libcamera.ControlInfo([0..4])), 'Sharpness': (libcamera.ControlId(22, Sharpness, ControlType.Float), libcamera.ControlInfo([0.000000..16.000000])), 'AwbEnable': (libcamera.ControlId(15, AwbEnable, ControlType.Bool), libcamera.ControlInfo([false..true])), 'StatsOutputEnable': (libcamera.ControlId(20001, StatsOutputEnable, ControlType.Bool), libcamera.ControlInfo([false..true])), 'Contrast': (libcamera.ControlId(13, Contrast, ControlType.Float), libcamera.ControlInfo([0.000000..32.000000])), 'Saturation': (libcamera.ControlId(20, Saturation, ControlType.Float), libcamera.ControlInfo([0.000000..32.000000])), 'Brightness': (libcamera.ControlId(12, Brightness, ControlType.Float), libcamera.ControlInfo([-1.000000..1.000000])), 'ColourGains': (libcamera.ControlId(18, ColourGains, ControlType.Float), libcamera.ControlInfo([0.000000..32.000000])), 'AeFlickerPeriod': (libcamera.ControlId(10, AeFlickerPeriod, ControlType.Integer32), libcamera.ControlInfo([100..1000000])), 'HdrMode': (libcamera.ControlId(41, HdrMode, ControlType.Integer32), libcamera.ControlInfo([0..4])), 'ExposureValue': (libcamera.ControlId(6, ExposureValue, ControlType.Float), libcamera.ControlInfo([-8.000000..8.000000])), 'ScalerCrop': (libcamera.ControlId(25, ScalerCrop, ControlType.Rectangle), libcamera.ControlInfo([(0, 440)/128x128..(0, 440)/4056x2160])), 'ExposureTime': (libcamera.ControlId(7, ExposureTime, ControlType.Integer32), libcamera.ControlInfo([60..0])), 'AeEnable': (libcamera.ControlId(1, AeEnable, ControlType.Bool), libcamera.ControlInfo([false..true]))}
    assert picam2.camera_properties_ == {
        "Model": "imx477",
        "UnitCellSize": (1550, 1550),
        "ColorFilterArrangement": 0,
        ...
        "PixelArraySize": (4056, 3040),
        "PixelArrayActiveAreas": [(8, 16, 4056, 3040)],
        "ScalerCropMaximum": (0, 440, 4056, 2160),
        "SystemDevices": (20750, 20751, 20737, 20738, 20739),
        "SensorSensitivity": 1.0,
    }
    # assert picam2.stream_map == {'main': <libcamera._libcamera.Stream object at 0x7f8ed88b70>, 'lores': None, 'raw': <libcamera._libcamera.Stream object at 0x7f8ed89830>}
    assert picam2.display_stream_name == "main"
    assert picam2.encode_stream_name == "main"
    assert picam2._max_queue_len == 1
    # assert picam2.streams == [<libcamera._libcamera.Stream object at 0x7f8ed88b70>, <libcamera._libcamera.Stream object at 0x7f8ed89830>]
    # assert picam2.camera_config == {'use_case': 'video', 'transform': <libcamera.Transform 'identity'>, 'colour_space': <libcamera.ColorSpace 'Rec709'>, 'buffer_count': 6, 'queue': True, 'main': {'format': 'XBGR8888', 'size': (1280, 720), 'stride': 5120, 'framesize': 3686400}, 'lores': None, 'raw': {'format': 'SBGGR12_CSI2P', 'size': (2028, 1080), 'stride': 3072, 'framesize': 3317760}, 'controls': {'NoiseReductionMode': <NoiseReductionModeEnum.Fast: 1>, 'FrameDurationLimits': (33333, 33333)}, 'sensor': {'bit_depth': 12, 'output_size': (2028, 1080)}, 'display': 'main', 'encode': 'main'}
    # ? assert picam2.allocator == <picamera2.allocators.dmaallocator.DmaAllocator object at 0x7f8edb4e10>
    # picam2.controls == <Controls: {'NoiseReductionMode': <NoiseReductionModeEnum.Fast: 1>, 'FrameDurationLimits': (33333, 33333)}>
    assert picam2.configure_count == 1


def test_configure_with_default_preview_configuration(executor: AstroPiExecutor):
    picam2 = Picamera2Adapter(executor)
    config = picam2.create_preview_configuration()
    picam2.configure(config)

    # picam2.libcamera_config == <libcamera._libcamera.CameraConfiguration object at 0x7f9e76bfb0>
    # assert picam2.camera_ctrl_info == {'AeExposureMode': (libcamera.ControlId(5, AeExposureMode, ControlType.Integer32), libcamera.ControlInfo([0..3])), 'AeMeteringMode': (libcamera.ControlId(3, AeMeteringMode, ControlType.Integer32), libcamera.ControlInfo([0..3])), 'AwbMode': (libcamera.ControlId(16, AwbMode, ControlType.Integer32), libcamera.ControlInfo([0..7])), 'AeFlickerMode': (libcamera.ControlId(9, AeFlickerMode, ControlType.Integer32), libcamera.ControlInfo([0..1])), 'AnalogueGain': (libcamera.ControlId(8, AnalogueGain, ControlType.Float), libcamera.ControlInfo([1.000000..22.260870])), 'FrameDurationLimits': (libcamera.ControlId(28, FrameDurationLimits, ControlType.Integer64), libcamera.ControlInfo([24994..674193371])), 'AeConstraintMode': (libcamera.ControlId(4, AeConstraintMode, ControlType.Integer32), libcamera.ControlInfo([0..3])), 'NoiseReductionMode': (libcamera.ControlId(10002, NoiseReductionMode, ControlType.Integer32), libcamera.ControlInfo([0..4])), 'Sharpness': (libcamera.ControlId(22, Sharpness, ControlType.Float), libcamera.ControlInfo([0.000000..16.000000])), 'AwbEnable': (libcamera.ControlId(15, AwbEnable, ControlType.Bool), libcamera.ControlInfo([false..true])), 'StatsOutputEnable': (libcamera.ControlId(20001, StatsOutputEnable, ControlType.Bool), libcamera.ControlInfo([false..true])), 'Contrast': (libcamera.ControlId(13, Contrast, ControlType.Float), libcamera.ControlInfo([0.000000..32.000000])), 'Saturation': (libcamera.ControlId(20, Saturation, ControlType.Float), libcamera.ControlInfo([0.000000..32.000000])), 'Brightness': (libcamera.ControlId(12, Brightness, ControlType.Float), libcamera.ControlInfo([-1.000000..1.000000])), 'ColourGains': (libcamera.ControlId(18, ColourGains, ControlType.Float), libcamera.ControlInfo([0.000000..32.000000])), 'AeFlickerPeriod': (libcamera.ControlId(10, AeFlickerPeriod, ControlType.Integer32), libcamera.ControlInfo([100..1000000])), 'HdrMode': (libcamera.ControlId(41, HdrMode, ControlType.Integer32), libcamera.ControlInfo([0..4])), 'ExposureValue': (libcamera.ControlId(6, ExposureValue, ControlType.Float), libcamera.ControlInfo([-8.000000..8.000000])), 'ScalerCrop': (libcamera.ControlId(25, ScalerCrop, ControlType.Rectangle), libcamera.ControlInfo([(0, 0)/128x128..(0, 0)/4056x3040])), 'ExposureTime': (libcamera.ControlId(7, ExposureTime, ControlType.Integer32), libcamera.ControlInfo([60..0])), 'AeEnable': (libcamera.ControlId(1, AeEnable, ControlType.Bool), libcamera.ControlInfo([false..true]))}
    assert picam2.camera_properties_ == {
        "Model": "imx477",
        "UnitCellSize": (1550, 1550),
        "ColorFilterArrangement": 0,
    ...
    # assert picam2.stream_map == {'main': <libcamera._libcamera.Stream object at 0x7f7a6b46f0>, 'lores': None, 'raw': <libcamera._libcamera.Stream object at 0x7f7a6b4670>}
    assert picam2.display_stream_name == "main"
    assert picam2.encode_stream_name == "main"
    assert picam2._max_queue_len == 1
    # assert picam2.streams == [<libcamera._libcamera.Stream object at 0x7f7a6b46f0>, <libcamera._libcamera.Stream object at 0x7f7a6b4670>]
    # assert picam2.camera_config == {'use_case': 'preview', 'transform': <libcamera.Transform 'identity'>, 'colour_space': <libcamera.ColorSpace 'sYCC'>, 'buffer_count': 4, 'queue': True, 'main': {'format': 'XBGR8888', 'size': (640, 480), 'stride': 2560, 'framesize': 1228800}, 'lores': None, 'raw': {'format': 'SBGGR12_CSI2P', 'size': (2028, 1520), 'stride': 3072, 'framesize': 4669440}, 'controls': {'NoiseReductionMode': <NoiseReductionModeEnum.Minimal: 3>, 'FrameDurationLimits': (100, 83333)}, 'sensor': {'bit_depth': 12, 'output_size': (2028, 1520)}, 'display': 'main', 'encode': 'main'}
    # ? assert picam2.allocator == <picamera2.allocators.dmaallocator.DmaAllocator object at 0x7f7a6b5010>
    # asssert picam2.controls == <Controls: {'NoiseReductionMode': <NoiseReductionModeEnum.Minimal: 3>, 'FrameDurationLimits': (100, 83333)}>
    assert picam2.configure_count == 1
