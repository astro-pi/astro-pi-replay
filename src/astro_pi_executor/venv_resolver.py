...
from astro_pi_executor.exception import AstroPiExecutorRuntimeError
...
class VenvResolver:
    ...
    def __init__(
        ...
        if venv_dir is None and init_venv:
            ...
            raise AstroPiExecutorRuntimeError(
    ...
    def _resolve_venv_dirs(self) -> VenvInfo:
        ...
        executor = script_dir / "astro_pi_executor"
        pip = script_dir / "pip"
        ...
        for path in mandatory_paths:
            if not path.exists():
                ...
                raise AstroPiExecutorRuntimeError(error_message)
    ...
    def _verify_platform(self) -> str:
        ...
        if (
            ...
            raise AstroPiExecutorRuntimeError(message)
        return sys.platform
