...
def main() -> None:
    ...
    arg_parser.add_argument("main", type=Path,
                            help="Path to the main.py file to run")
    ...
    arg_parser.add_argument("--mode", type=ExecutionMode, 
                            required=False,
                            # default=detect_execution_mode(),
                            help="Whether to replay data or fetch" +
                            "live data")
    #arg_parser.add_argument("--data_dir", type=Path,
    #                        required=False,
    #                        # default=default_dir,
    #                        help="Path to place downloaded data files")
    arg_parser.add_argument("--venv_dir", type=Path, 
                            required=False,
                            # default=default_dir,
