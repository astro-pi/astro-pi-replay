...
class PixelFormat(metaclass=PixelFormatSingleton):
    def __init__(self, fourcc: int, modifier: int, _name: str) -> None:
...
R8 = PixelFormat(__fourcc("R", "8", " ", " "), __mod(0, 0), "R8")
R10 = PixelFormat(__fourcc("R", "1", "0", " "), __mod(0, 0), "R10")
R12 = PixelFormat(__fourcc("R", "1", "2", " "), __mod(0, 0), "R12")
R16 = PixelFormat(__fourcc("R", "1", "6", " "), __mod(0, 0), "R16")
RGB565 = PixelFormat(__fourcc("R", "G", "1", "6"), __mod(0, 0), "RGB565")
RGB565_BE = PixelFormat(__fourcc("R", "G", "1", "6"), __mod(0, 0), "RGB565_BE")
RGB888 = PixelFormat(__fourcc("R", "G", "2", "4"), __mod(0, 0), "RGB888")
BGR888 = PixelFormat(__fourcc("B", "G", "2", "4"), __mod(0, 0), "BGR888")
XRGB8888 = PixelFormat(__fourcc("X", "R", "2", "4"), __mod(0, 0), "XRGB8888")
XBGR8888 = PixelFormat(__fourcc("X", "B", "2", "4"), __mod(0, 0), "XBGR8888")
RGBX8888 = PixelFormat(__fourcc("R", "X", "2", "4"), __mod(0, 0), "RGBX8888")
BGRX8888 = PixelFormat(__fourcc("B", "X", "2", "4"), __mod(0, 0), "BGRX8888")
ARGB8888 = PixelFormat(__fourcc("A", "R", "2", "4"), __mod(0, 0), "ARGB8888")
ABGR8888 = PixelFormat(__fourcc("A", "B", "2", "4"), __mod(0, 0), "ABGR8888")
RGBA8888 = PixelFormat(__fourcc("R", "A", "2", "4"), __mod(0, 0), "RGBA8888")
BGRA8888 = PixelFormat(__fourcc("B", "A", "2", "4"), __mod(0, 0), "BGRA8888")
RGB161616 = PixelFormat(__fourcc("R", "G", "4", "8"), __mod(0, 0), "RGB161616")
BGR161616 = PixelFormat(__fourcc("B", "G", "4", "8"), __mod(0, 0), "BGR161616")
YUYV = PixelFormat(__fourcc("Y", "U", "Y", "V"), __mod(0, 0), "YUYV")
YVYU = PixelFormat(__fourcc("Y", "V", "Y", "U"), __mod(0, 0), "YVYU")
UYVY = PixelFormat(__fourcc("U", "Y", "V", "Y"), __mod(0, 0), "UYVY")
VYUY = PixelFormat(__fourcc("V", "Y", "U", "Y"), __mod(0, 0), "VYUY")
AVUY8888 = PixelFormat(__fourcc("A", "V", "U", "Y"), __mod(0, 0), "AVUY8888")
XVUY8888 = PixelFormat(__fourcc("X", "V", "U", "Y"), __mod(0, 0), "XVUY8888")
NV12 = PixelFormat(__fourcc("N", "V", "1", "2"), __mod(0, 0), "NV12")
NV21 = PixelFormat(__fourcc("N", "V", "2", "1"), __mod(0, 0), "NV21")
NV16 = PixelFormat(__fourcc("N", "V", "1", "6"), __mod(0, 0), "NV16")
NV61 = PixelFormat(__fourcc("N", "V", "6", "1"), __mod(0, 0), "NV61")
NV24 = PixelFormat(__fourcc("N", "V", "2", "4"), __mod(0, 0), "NV24")
NV42 = PixelFormat(__fourcc("N", "V", "4", "2"), __mod(0, 0), "NV42")
YUV420 = PixelFormat(__fourcc("Y", "U", "1", "2"), __mod(0, 0), "YUV420")
YVU420 = PixelFormat(__fourcc("Y", "V", "1", "2"), __mod(0, 0), "YVU420")
YUV422 = PixelFormat(__fourcc("Y", "U", "1", "6"), __mod(0, 0), "YUV422")
YVU422 = PixelFormat(__fourcc("Y", "V", "1", "6"), __mod(0, 0), "YVU422")
YUV444 = PixelFormat(__fourcc("Y", "U", "2", "4"), __mod(0, 0), "YUV444")
YVU444 = PixelFormat(__fourcc("Y", "V", "2", "4"), __mod(0, 0), "YVU444")
MJPEG = PixelFormat(__fourcc("M", "J", "P", "G"), __mod(0, 0), "MJPEG")
SRGGB8 = PixelFormat(__fourcc("R", "G", "G", "B"), __mod(0, 0), "SRGGB8")
SGRBG8 = PixelFormat(__fourcc("G", "R", "B", "G"), __mod(0, 0), "SGRBG8")
SGBRG8 = PixelFormat(__fourcc("G", "B", "R", "G"), __mod(0, 0), "SGBRG8")
SBGGR8 = PixelFormat(__fourcc("B", "A", "8", "1"), __mod(0, 0), "SBGGR8")
SRGGB10 = PixelFormat(__fourcc("R", "G", "1", "0"), __mod(0, 0), "SRGGB10")
SGRBG10 = PixelFormat(__fourcc("B", "A", "1", "0"), __mod(0, 0), "SGRBG10")
SGBRG10 = PixelFormat(__fourcc("G", "B", "1", "0"), __mod(0, 0), "SGBRG10")
SBGGR10 = PixelFormat(__fourcc("B", "G", "1", "0"), __mod(0, 0), "SBGGR10")
SRGGB12 = PixelFormat(__fourcc("R", "G", "1", "2"), __mod(0, 0), "SRGGB12")
SGRBG12 = PixelFormat(__fourcc("B", "A", "1", "2"), __mod(0, 0), "SGRBG12")
SGBRG12 = PixelFormat(__fourcc("G", "B", "1", "2"), __mod(0, 0), "SGBRG12")
SBGGR12 = PixelFormat(__fourcc("B", "G", "1", "2"), __mod(0, 0), "SBGGR12")
SRGGB14 = PixelFormat(__fourcc("R", "G", "1", "4"), __mod(0, 0), "SRGGB14")
SGRBG14 = PixelFormat(__fourcc("B", "A", "1", "4"), __mod(0, 0), "SGRBG14")
SGBRG14 = PixelFormat(__fourcc("G", "B", "1", "4"), __mod(0, 0), "SGBRG14")
SBGGR14 = PixelFormat(__fourcc("B", "G", "1", "4"), __mod(0, 0), "SBGGR14")
SRGGB16 = PixelFormat(__fourcc("R", "G", "B", "6"), __mod(0, 0), "SRGGB16")
SGRBG16 = PixelFormat(__fourcc("G", "R", "1", "6"), __mod(0, 0), "SGRBG16")
SGBRG16 = PixelFormat(__fourcc("G", "B", "1", "6"), __mod(0, 0), "SGBRG16")
SBGGR16 = PixelFormat(__fourcc("B", "Y", "R", "2"), __mod(0, 0), "SBGGR16")
R10_CSI2P = PixelFormat(__fourcc("R", "1", "0", " "), __mod(11, 1), "R10_CSI2P")
SRGGB10_CSI2P = PixelFormat(__fourcc("R", "G", "1", "0"), __mod(11, 1), "SRGGB10_CSI2P")
SGRBG10_CSI2P = PixelFormat(__fourcc("B", "A", "1", "0"), __mod(11, 1), "SGRBG10_CSI2P")
SGBRG10_CSI2P = PixelFormat(__fourcc("G", "B", "1", "0"), __mod(11, 1), "SGBRG10_CSI2P")
SBGGR10_CSI2P = PixelFormat(__fourcc("B", "G", "1", "0"), __mod(11, 1), "SBGGR10_CSI2P")
SRGGB12_CSI2P = PixelFormat(__fourcc("R", "G", "1", "2"), __mod(11, 1), "SRGGB12_CSI2P")
SGRBG12_CSI2P = PixelFormat(__fourcc("B", "A", "1", "2"), __mod(11, 1), "SGRBG12_CSI2P")
SGBRG12_CSI2P = PixelFormat(__fourcc("G", "B", "1", "2"), __mod(11, 1), "SGBRG12_CSI2P")
SBGGR12_CSI2P = PixelFormat(__fourcc("B", "G", "1", "2"), __mod(11, 1), "SBGGR12_CSI2P")
SRGGB14_CSI2P = PixelFormat(__fourcc("R", "G", "1", "4"), __mod(11, 1), "SRGGB14_CSI2P")
SGRBG14_CSI2P = PixelFormat(__fourcc("B", "A", "1", "4"), __mod(11, 1), "SGRBG14_CSI2P")
SGBRG14_CSI2P = PixelFormat(__fourcc("G", "B", "1", "4"), __mod(11, 1), "SGBRG14_CSI2P")
SBGGR14_CSI2P = PixelFormat(__fourcc("B", "G", "1", "4"), __mod(11, 1), "SBGGR14_CSI2P")
SRGGB10_IPU3 = PixelFormat(__fourcc("R", "G", "1", "0"), __mod(1, 13), "SRGGB10_IPU3")
SGRBG10_IPU3 = PixelFormat(__fourcc("B", "A", "1", "0"), __mod(1, 13), "SGRBG10_IPU3")
SGBRG10_IPU3 = PixelFormat(__fourcc("G", "B", "1", "0"), __mod(1, 13), "SGBRG10_IPU3")
SBGGR10_IPU3 = PixelFormat(__fourcc("B", "G", "1", "0"), __mod(1, 13), "SBGGR10_IPU3")
RGGB_PISP_COMP1 = PixelFormat(__fourcc("R", "G", "B", "6"), __mod(12, 1), "RGGB_PISP_COMP1")
GRBG_PISP_COMP1 = PixelFormat(__fourcc("G", "R", "1", "6"), __mod(12, 1), "GRBG_PISP_COMP1")
GBRG_PISP_COMP1 = PixelFormat(__fourcc("G", "B", "1", "6"), __mod(12, 1), "GBRG_PISP_COMP1")
BGGR_PISP_COMP1 = PixelFormat(__fourcc("B", "Y", "R", "2"), __mod(12, 1), "BGGR_PISP_COMP1")
MONO_PISP_COMP1 = PixelFormat(__fourcc("R", "1", "6", " "), __mod(12, 1), "MONO_PISP_COMP1")
