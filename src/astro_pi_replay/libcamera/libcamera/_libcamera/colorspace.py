...
class ColorSpace(metaclass=ColorSpaceMeta):
    ...
    def Raw() -> "ColorSpace":
        return ColorSpace(
            Primaries.Raw, TransferFunction.Linear, YcbcrEncoding.Null, Range.Full
        )

    @staticmethod
    def Srgb() -> "ColorSpace":
        return ColorSpace(
            Primaries.Rec709, TransferFunction.Srgb, YcbcrEncoding.Null, Range.Full
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            ...
            and self.transferFunction == other.transferFunction
            and self.ycbcrEncoding == other.ycbcrEncoding
