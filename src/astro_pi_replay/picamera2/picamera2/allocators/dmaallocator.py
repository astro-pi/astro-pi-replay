...
class DmaAllocator(Allocator):
    ...
    def __init__(self):
        ...
        self.frame_buffers: dict[Stream, list[FrameBuffer]] = {}
        self.open_fds = []
        self.libcamera_fds = []
    ...
    def allocate(self, libcamera_config, use_case):
        ...
        for c, stream_config in enumerate(libcamera_config):
            ...
            for i in range(stream_config.buffer_count):
                ...
                memory = mmap.mmap(plane[0].fd, stream_config.frame_size)
    ...
    # this might just be implementable as an os.flush()
    class DmaSync(Sync):
        pass
