...
#        self, functions, wait, signal_function=None, immediate=False
#    ) -> None:
...
#            partial(self.set_frame_drops_, num_frames),
#            self.drop_frames_,
#        ]
#        return self.dispatch_functions(functions, wait, signal_function, immediate=True)
#
...
#            self, file_output, preview_config, format, exif_data=exif_data
#        ):
#            done, result = self.capture_file_(
#                file_output, name, format=format, exif_data=exif_data
#            )
#            if not done:
#                return (False, None)
...
#        return self.dispatch_functions(
...
#                self.switch_mode_and_capture_file(
#                    capture_mode, name.format(i), exif_data=exif_data
#                )
#        else:
